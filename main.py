...
def get_module():
    result = questionary.select(
        ...
        choices=[
            ...
            Choice("10) Multi Tasks", multitasks),
            Choice("11) Get refuel fees", get_fees_refuel),
            Choice("12) Deploy contracts", deploy_contracts),
            Choice("13) Create wallets", create_wallets),
            Choice("14) Check balances", check_balance),
        ],
        qmark="⚙️ ",
        pointer="✅ ",
    ).ask()
